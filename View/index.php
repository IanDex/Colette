    ...
    if (!document.fullscreenElement && // alternative standard method
        ...
        if (document.cancelFullScreen) {
            ...
            document.webkitCancelFullScreen();
                            ...
                            <a href="#" onclick="javascript:toggleFullScreen();" class="dropdown-item">Fullscreen</a>
            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                    ...
                    <?php $menu = new Conexion(); ?>
                    <ul class="navigation">
                      <?php foreach ($menu->getMenu() as $m){?>
                        <li class="navigation__sub">
                            <a href="#"><i class="zmdi zmdi-view-week"></i> <?php echo $m['Nombre']; ?></a>
                            <ul>
                              <?php foreach ($menu->getSubMenu($m['id_menu']) as $s){?>
                                <li><a href="top-navigation.html"><?php echo $s['Nombre']; ?></a></li>
                              <?php } ?>
                            </ul>
                        </li>
                      <?php } ?>
            ...
            <section class="content">
                <header class="content__title">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                          <select class="select2" data-placeholder="Base de Datos">
                              <option></option>
                              <?php foreach ($menu->getDatabase() as $db){
                                if ($db['Database'] != 'phpmyadmin' && $db['Database'] != 'sql' && $db['Database'] != 'test' && $db['Database'] != 'performance_schema' && $db['Database'] != 'mysql' && $db['Database'] != 'information_schema') {
                                ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                          <select class="select2" data-placeholder="Tabla">
                              <option></option>
                              <?php foreach ($menu->getTablas() as $tablas){?>
                                <option><?php echo $tablas['Tables_in_colette']; ?></option>>
                              <?php } ?>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                          <select class="select2" multiple data-placeholder="Columnas">
                            <option></option>
